...
import { Image as ImageIcon, Video, Layers, ChevronRight, HardDrive } from 'lucide-react';
  ...
  return (
    <Link href={`/albums/${album.id}`}>
      <motion.div
        ...
        className="glass-panel glass-panel-hover rounded-3xl overflow-hidden group cursor-pointer border border-zinc-800/80 flex flex-col h-full"
      >
